...
// (`confluence-dc-mcp`, `confluence-dc-mcp-populate-embeddings`, `confluence-dc-mcp-healthcheck`)
...
// `confluence-dc-mcp`'s own entry-point wiring, used by no other binary.
