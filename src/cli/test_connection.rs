...
use confluence_dc_mcp::core::api_url_builder::build_api_url;
use confluence_dc_mcp::core::config_manager::load_config;
use confluence_dc_mcp::core::config_schema::Transport;

async fn probe(
    config: &confluence_dc_mcp::core::config_schema::Config,
...
mod tests {
    ...
    fn config(url: String) -> confluence_dc_mcp::core::config_schema::Config {
